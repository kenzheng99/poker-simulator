...
class Hand:
    ...
    def isStraight(hand):
        ...
        if (
            hand.cards[0].rank == Rank.fromString("A")
    ...
    @staticmethod
    def isQuads(hand):
        return Hand.areAllRanksEqual(hand, [0, 1, 2, 3]) or Hand.areAllRanksEqual(
            hand, [1, 2, 3, 4]
        )
    ...
    def isFullHouse(hand):
        return (
            Hand.areAllRanksEqual(hand, [0, 1, 2])
            and Hand.areAllRanksEqual(hand, [3, 4])
            or Hand.areAllRanksEqual(hand, [0, 1])
            and Hand.areAllRanksEqual(hand, [2, 3, 4])
        )
...
if __name__ == "__main__":
    ...
    print(
        f"{straightHand} is straight: {Hand.isStraight(straightHand)}, score: {straightHand.calculateScore()}"
    )
    ...
    print(
        f"{straightFlushHand} is straight flush: {Hand.isStraightFlush(straightFlushHand)}"
    )
